    ...
    <div className=" text-neutral-900">
      ...
      <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
          <div className="prose prose-neutral max-w-none prose-headings:scroll-mt-24 prose-headings:font-bold prose-h2:mt-10 prose-h2:text-2xl prose-h3:mt-8 prose-h3:text-xl prose-p:leading-7 prose-li:leading-7">
            ...
            <p>
              ...
              Schriftarten sogenannte Web Fonts von Adobe Typekit. Anbieter ist
              die Adobe Systems Incorporated, 345 Park Avenue, San Jose, CA
            ...
            <p>
              Die Nutzung von Adobe Typekit Web Fonts ist erforderlich, um ein
              einheitliches Schriftbild auf unserer Website zu gewährleisten.
              Dies stellt ein berechtigtes Interesse im Sinne des Art. 6 Abs. 1
              lit. f DSGVO dar.
            </p>
            <p>
              Nähere Informationen zu Adobe Typekit Web Fonts erhalten Sie
              unter:{" "}
              <a
